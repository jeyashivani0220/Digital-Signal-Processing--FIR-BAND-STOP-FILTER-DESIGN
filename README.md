...
hn=hd.*wh   
% Plot the Band Stop Filter with hamming
% Window Technique 
w=0:0.01:pi;  
h=freqz(hn,1,w); 
plot(w/pi,abs(h),'ms');
...
## OUTPUT:
<img width="831" height="745" alt="image" src="https://github.com/user-attachments/assets/495fe6ec-4f8b-47da-859c-169163f2a15f" />
